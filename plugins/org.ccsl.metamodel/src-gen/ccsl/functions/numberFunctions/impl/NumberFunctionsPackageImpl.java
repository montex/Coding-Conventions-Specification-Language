...
import ccsl.functions.numberFunctions.CcslIntegerLiteral;
import ccsl.functions.numberFunctions.CcslNumberFunction;
 ...
 * @generated
 */
public class NumberFunctionsPackageImpl extends EPackageImpl implements NumberFunctionsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass ccslNumberFunctionEClass = null;
	 ...
	 * @generated
	 */
	private EClass ccslIntegerLiteralEClass = null;
	 ...
	 * @generated
	 */
	private EClass getIndexOfEClass = null;
	 ...
	 * @see ccsl.functions.numberFunctions.NumberFunctionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private NumberFunctionsPackageImpl() {
		super(eNS_URI, NumberFunctionsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link NumberFunctionsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static NumberFunctionsPackage init() {
		if (isInited)
			return (NumberFunctionsPackage) EPackage.Registry.INSTANCE.getEPackage(NumberFunctionsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredNumberFunctionsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		NumberFunctionsPackageImpl theNumberFunctionsPackage = registeredNumberFunctionsPackage instanceof NumberFunctionsPackageImpl
				? (NumberFunctionsPackageImpl) registeredNumberFunctionsPackage
				: new NumberFunctionsPackageImpl();
		...
		theNumberFunctionsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(NumberFunctionsPackage.eNS_URI, theNumberFunctionsPackage);
		return theNumberFunctionsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getCcslNumberFunction() {
		return ccslNumberFunctionEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getCcslIntegerLiteral() {
		return ccslIntegerLiteralEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getCcslIntegerLiteral_Value() {
		return (EAttribute) ccslIntegerLiteralEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getGetIndexOf() {
		return getIndexOfEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGetIndexOf_Container() {
		return (EReference) getIndexOfEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getGetIndexOf_Field() {
		return (EReference) getIndexOfEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public NumberFunctionsFactory getNumberFunctionsFactory() {
		return (NumberFunctionsFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		ccslNumberFunctionEClass = createEClass(CCSL_NUMBER_FUNCTION);

		ccslIntegerLiteralEClass = createEClass(CCSL_INTEGER_LITERAL);
		createEAttribute(ccslIntegerLiteralEClass, CCSL_INTEGER_LITERAL__VALUE);

		getIndexOfEClass = createEClass(GET_INDEX_OF);
		createEReference(getIndexOfEClass, GET_INDEX_OF__CONTAINER);
		createEReference(getIndexOfEClass, GET_INDEX_OF__FIELD);
	}
	...
	public void initializePackageContents() {
		...
		FunctionsPackage theFunctionsPackage = (FunctionsPackage) EPackage.Registry.INSTANCE
		...
		ccslNumberFunctionEClass.getESuperTypes().add(theFunctionsPackage.getCcslFunction());
		ccslIntegerLiteralEClass.getESuperTypes().add(this.getCcslNumberFunction());
		getIndexOfEClass.getESuperTypes().add(this.getCcslNumberFunction());

		// Initialize classes and features; add operations and parameters
		initEClass(ccslNumberFunctionEClass, CcslNumberFunction.class, "CcslNumberFunction", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(ccslIntegerLiteralEClass, CcslIntegerLiteral.class, "CcslIntegerLiteral", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCcslIntegerLiteral_Value(), theXMLTypePackage.getInt(), "value", null, 0, 1,
				CcslIntegerLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(getIndexOfEClass, GetIndexOf.class, "GetIndexOf", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGetIndexOf_Container(), theElementsPackage.getElement(), null, "container", null, 1, 1,
				GetIndexOf.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGetIndexOf_Field(), theElementsPackage.getElement(), null, "field", null, 1, 1,
				GetIndexOf.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //NumberFunctionsPackageImpl
