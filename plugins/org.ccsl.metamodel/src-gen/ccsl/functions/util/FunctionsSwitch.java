/**
 */
package ccsl.functions.util;

import ccsl.functions.*;
 ...
 * <!-- end-user-doc -->
 * @see ccsl.functions.FunctionsPackage
 * @generated
 */
public class FunctionsSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case FunctionsPackage.CCSL_FUNCTION: {
			CcslFunction ccslFunction = (CcslFunction) theEObject;
			Object result = caseCcslFunction(ccslFunction);
			if (result == null)
