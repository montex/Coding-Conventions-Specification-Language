 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.functions.booleanFunctions.filters.impl.CompositeFilterImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link ccsl.functions.booleanFunctions.filters.impl.CompositeFilterImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeFilterImpl extends FilterImpl implements CompositeFilter {
	...
	public EList getFilters() {
		if (filters == null) {
			filters = new EObjectContainmentEList(Filter.class, this, FiltersPackage.COMPOSITE_FILTER__FILTERS);
		}
		return filters;
	}
