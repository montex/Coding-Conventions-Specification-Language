...
import ccsl.functions.booleanFunctions.BooleanFunctionsFactory;
 ...
 * @generated
 */
public class BooleanFunctionsPackageImpl extends EPackageImpl implements BooleanFunctionsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass ccslBooleanFunctionEClass = null;
	 ...
	 * @see ccsl.functions.booleanFunctions.BooleanFunctionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BooleanFunctionsPackageImpl() {
		super(eNS_URI, BooleanFunctionsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link BooleanFunctionsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BooleanFunctionsPackage init() {
		if (isInited)
			return (BooleanFunctionsPackage) EPackage.Registry.INSTANCE.getEPackage(BooleanFunctionsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBooleanFunctionsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		BooleanFunctionsPackageImpl theBooleanFunctionsPackage = registeredBooleanFunctionsPackage instanceof BooleanFunctionsPackageImpl
				? (BooleanFunctionsPackageImpl) registeredBooleanFunctionsPackage
				: new BooleanFunctionsPackageImpl();
		...
		theBooleanFunctionsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BooleanFunctionsPackage.eNS_URI, theBooleanFunctionsPackage);
		return theBooleanFunctionsPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getCcslBooleanFunction() {
		return ccslBooleanFunctionEClass;
	}
	 ...
	 * @generated
	 */
	public BooleanFunctionsFactory getBooleanFunctionsFactory() {
		return (BooleanFunctionsFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		ccslBooleanFunctionEClass = createEClass(CCSL_BOOLEAN_FUNCTION);
	}
	...
	public void initializePackageContents() {
		...
		ccslBooleanFunctionEClass.getESuperTypes().add(theFunctionsPackage.getCcslFunction());

		// Initialize classes and features; add operations and parameters
		initEClass(ccslBooleanFunctionEClass, CcslBooleanFunction.class, "CcslBooleanFunction", IS_ABSTRACT,
