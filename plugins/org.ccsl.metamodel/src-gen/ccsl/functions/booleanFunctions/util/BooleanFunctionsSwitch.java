/**
 */
package ccsl.functions.booleanFunctions.util;
 ...
 * @generated
 */
public class BooleanFunctionsSwitch {
	/**
	 ...
	 * @generated
	 */
	protected static BooleanFunctionsPackage modelPackage;
	 ...
	 * @generated
	 */
	public BooleanFunctionsSwitch() {
		if (modelPackage == null) {
			modelPackage = BooleanFunctionsPackage.eINSTANCE;
		}
	}
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case BooleanFunctionsPackage.CCSL_BOOLEAN_FUNCTION: {
			CcslBooleanFunction ccslBooleanFunction = (CcslBooleanFunction) theEObject;
			Object result = caseCcslBooleanFunction(ccslBooleanFunction);
			if (result == null)
				result = caseCcslFunction(ccslBooleanFunction);
			if (result == null)
