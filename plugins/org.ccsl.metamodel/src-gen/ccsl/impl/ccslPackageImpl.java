...
public class ccslPackageImpl extends EPackageImpl implements ccslPackage {
	...
	public static ccslPackage init() {
		...
		Object registeredccslPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ccslPackageImpl theccslPackage = registeredccslPackage instanceof ccslPackageImpl
				? (ccslPackageImpl) registeredccslPackage
				: new ccslPackageImpl();
	 ...
	 * @generated
	 */
	public EReference getAtomicRule_Subject() {
	 ...
	 * @generated
	 */
	public EReference getAtomicRule_Context() {
	...
	public void createPackageContents() {
		...
		createEReference(atomicRuleEClass, ATOMIC_RULE__SUBJECT);
		createEReference(atomicRuleEClass, ATOMIC_RULE__CONTEXT);
	...
	public void initializePackageContents() {
		...
		ruleEClass.getESuperTypes().add(this.getRoot());
		...
		initEReference(getCompositeRule_Rules(), this.getRule(), null, "rules", null, 2, -1, CompositeRule.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(atomicRuleEClass, AtomicRule.class, "AtomicRule", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAtomicRule_Subject(), theElementsPackage.getElement(), null, "subject", null, 1, 1,
				AtomicRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAtomicRule_Context(), theContextPackage.getContext(), null, "context", null, 1, 1,
				AtomicRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(collectionKindEEnum, CollectionKind.EXACT_LITERAL);
		addEEnumLiteral(collectionKindEEnum, CollectionKind.SEQUENCE_LITERAL);
		addEEnumLiteral(collectionKindEEnum, CollectionKind.ANY_LITERAL);
		addEEnumLiteral(collectionKindEEnum, CollectionKind.IMMEDIATE_LITERAL);
