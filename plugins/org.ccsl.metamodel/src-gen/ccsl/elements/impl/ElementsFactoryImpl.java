...
public class ElementsFactoryImpl extends EFactoryImpl implements ElementsFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case ElementsPackage.VISIBILITY:
			return createVisibilityFromString(eDataType, initialValue);
		case ElementsPackage.INHERITANCE:
			return createInheritanceFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		case ElementsPackage.INHERITANCE:
			return convertInheritanceToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public Inheritance createInheritanceFromString(EDataType eDataType, String initialValue) {
		Inheritance result = Inheritance.get(initialValue);
		if (result == null)
			throw new IllegalArgumentException(
					"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	 ...
	 * @generated
	 */
	public String convertInheritanceToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
