/**
 */
package ccsl.elements.util;

import ccsl.elements.*;
 ...
 * <!-- end-user-doc -->
 * @see ccsl.elements.ElementsPackage
 * @generated
 */
public class ElementsSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case ElementsPackage.CONTROLLED_ACCESS_ELEMENT: {
			ControlledAccessElement controlledAccessElement = (ControlledAccessElement) theEObject;
			Object result = caseControlledAccessElement(controlledAccessElement);
			if (result == null)
				result = caseElement(controlledAccessElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ElementsPackage.ANNOTABLE: {
			Annotable annotable = (Annotable) theEObject;
			Object result = caseAnnotable(annotable);
			if (result == null)
				result = caseElement(annotable);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
