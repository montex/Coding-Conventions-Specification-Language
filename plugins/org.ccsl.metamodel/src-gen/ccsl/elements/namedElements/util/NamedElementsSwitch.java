 ...
 * @generated
 */
public class NamedElementsSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case NamedElementsPackage.NAMED_ELEMENT: {
			...
			if (result == null)
				result = caseAnnotable(namedElement);
			if (result == null)
		...
		case NamedElementsPackage.PACKAGE: {
			ccsl.elements.namedElements.Package package_ = (ccsl.elements.namedElements.Package) theEObject;
			Object result = casePackage(package_);
			if (result == null)
				result = caseNamedElement(package_);
			if (result == null)
				result = caseImportableElement(package_);
			if (result == null)
