...
public class MethodSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case MethodPackage.CONSTRUCTOR: {
			...
			if (result == null)
				result = caseSimpleMethod(constructor);
			if (result == null)
				result = caseControlledAccessElement(constructor);
			if (result == null)
				result = caseAnnotable(constructor);
			if (result == null)
		...
		case MethodPackage.SIMPLE_METHOD: {
			...
			Object result = caseSimpleMethod(simpleMethod);
			if (result == null)
				result = caseControlledAccessElement(simpleMethod);
			if (result == null)
				result = caseAnnotable(simpleMethod);
			if (result == null)
				result = caseElement(simpleMethod);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MethodPackage.METHOD: {
			...
			if (result == null)
				result = caseSimpleMethod(method);
			if (result == null)
				result = caseAnnotable(method);
			if (result == null)
				result = caseControlledAccessElement(method);
			if (result == null)
