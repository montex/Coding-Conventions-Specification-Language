 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.expressions.impl.BinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BinaryExpressionImpl extends OperandExpressionImpl implements BinaryExpression {
	/**
	 ...
	 * @ordered
	 */
	protected static final BinaryOperator OPERATOR_EDEFAULT = BinaryOperator.ANY_LITERAL;
	...
	public void setOperator(BinaryOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.BINARY_EXPRESSION__OPERATOR,
