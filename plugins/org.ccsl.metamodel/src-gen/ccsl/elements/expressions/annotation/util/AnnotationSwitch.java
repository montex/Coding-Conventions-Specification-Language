/**
 */
package ccsl.elements.expressions.annotation.util;
...
public class AnnotationSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case AnnotationPackage.ANNOTATION: {
			...
			if (result == null)
				result = caseExpression(annotation);
			if (result == null)
		...
		case AnnotationPackage.ANNOTATION_FIELD_VALUE: {
			AnnotationFieldValue annotationFieldValue = (AnnotationFieldValue) theEObject;
			Object result = caseAnnotationFieldValue(annotationFieldValue);
			if (result == null)
				result = caseElement(annotationFieldValue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public Object caseAnnotationFieldValue(AnnotationFieldValue object) {
		return null;
	}
