...
public class AnnotationPackageImpl extends EPackageImpl implements AnnotationPackage {
	 ...
	 * @generated
	 */
	private EClass annotationFieldValueEClass = null;
	 ...
	 * @see ccsl.elements.expressions.annotation.AnnotationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getAnnotation_ValuesKind() {
	 ...
	 * @generated
	 */
	public EClass getAnnotationFieldValue() {
		return annotationFieldValueEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAnnotationFieldValue_Value() {
		return (EReference) annotationFieldValueEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAnnotationFieldValue_Field() {
		return (EReference) annotationFieldValueEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(annotationEClass, ANNOTATION__VALUES_KIND);

		annotationFieldValueEClass = createEClass(ANNOTATION_FIELD_VALUE);
		createEReference(annotationFieldValueEClass, ANNOTATION_FIELD_VALUE__VALUE);
		createEReference(annotationFieldValueEClass, ANNOTATION_FIELD_VALUE__FIELD);
	}
	...
	public void initializePackageContents() {
		...
		annotationEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
		annotationFieldValueEClass.getESuperTypes().add(theElementsPackage.getElement());

		// Initialize classes and features; add operations and parameters
		initEClass(annotationEClass, Annotation.class, "Annotation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAnnotation_Type(), theComplexTypePackage.getAnnotationType(), null, "type", null, 0, 1,
				Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAnnotation_Values(), this.getAnnotationFieldValue(), null, "values", null, 0, -1,
				Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAnnotation_ValuesKind(), theccslPackage.getCollectionKind(), "valuesKind", "ANY", 0, 1,
				Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(annotationFieldValueEClass, AnnotationFieldValue.class, "AnnotationFieldValue", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAnnotationFieldValue_Value(), theExpressionsPackage.getExpression(), null, "value", null, 0,
				1, AnnotationFieldValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAnnotationFieldValue_Field(), theComplexTypePackage.getAnnotationField(), null, "field", null,
				0, 1, AnnotationFieldValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
