...
public class ArraysPackageImpl extends EPackageImpl implements ArraysPackage {
	 ...
	 * @generated
	 */
	private EClass arrayIndexesAccessEClass = null;
	 ...
	 * @see ccsl.elements.expressions.arrays.ArraysPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getArrayCreation_DimensionsKind() {
		return (EAttribute) arrayCreationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getArrayIndexesAccess() {
		return arrayIndexesAccessEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getArrayIndexesAccess_Indexes() {
		return (EReference) arrayIndexesAccessEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getArrayIndexesAccess_IndexesKind() {
		return (EAttribute) arrayIndexesAccessEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getArrayInitializer_ValuesKind() {
		return (EAttribute) arrayInitializerEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(arrayCreationEClass, ARRAY_CREATION__DIMENSIONS_KIND);

		arrayIndexesAccessEClass = createEClass(ARRAY_INDEXES_ACCESS);
		createEReference(arrayIndexesAccessEClass, ARRAY_INDEXES_ACCESS__INDEXES);
		createEAttribute(arrayIndexesAccessEClass, ARRAY_INDEXES_ACCESS__INDEXES_KIND);

		arrayInitializerEClass = createEClass(ARRAY_INITIALIZER);
		createEReference(arrayInitializerEClass, ARRAY_INITIALIZER__VALUES);
		createEAttribute(arrayInitializerEClass, ARRAY_INITIALIZER__VALUES_KIND);
	}
	...
	public void initializePackageContents() {
		...
		arrayCreationEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
		arrayIndexesAccessEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
		arrayInitializerEClass.getESuperTypes().add(theExpressionsPackage.getExpression());

		// Initialize classes and features; add operations and parameters
		initEClass(arrayCreationEClass, ArrayCreation.class, "ArrayCreation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArrayCreation_Type(), theDatatypePackage.getObjectType(), null, "type", null, 0, 1,
				ArrayCreation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArrayCreation_Initializer(), this.getArrayInitializer(), null, "initializer", null, 0, 1,
				ArrayCreation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArrayCreation_Dimensions(), theExpressionsPackage.getExpression(), null, "dimensions", null,
				0, -1, ArrayCreation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArrayCreation_DimensionsKind(), theccslPackage.getCollectionKind(), "dimensionsKind", "ANY",
				0, 1, ArrayCreation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(arrayIndexesAccessEClass, ArrayIndexesAccess.class, "ArrayIndexesAccess", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArrayIndexesAccess_Indexes(), theExpressionsPackage.getExpression(), null, "indexes", null, 0,
				-1, ArrayIndexesAccess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArrayIndexesAccess_IndexesKind(), theccslPackage.getCollectionKind(), "indexesKind", "ANY", 0,
				1, ArrayIndexesAccess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(arrayInitializerEClass, ArrayInitializer.class, "ArrayInitializer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getArrayInitializer_Values(), theExpressionsPackage.getExpression(), null, "values", null, 0, -1,
				ArrayInitializer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getArrayInitializer_ValuesKind(), theccslPackage.getCollectionKind(), "valuesKind", "ANY", 0, -1,
				ArrayInitializer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
