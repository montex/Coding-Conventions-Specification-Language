/**
 */
package ccsl.elements.expressions.arrays.util;
...
public class ArraysSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case ArraysPackage.ARRAY_CREATION: {
			...
			Object result = caseArrayCreation(arrayCreation);
			if (result == null)
				result = caseExpression(arrayCreation);
			if (result == null)
				result = caseElement(arrayCreation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArraysPackage.ARRAY_INDEXES_ACCESS: {
			ArrayIndexesAccess arrayIndexesAccess = (ArrayIndexesAccess) theEObject;
			Object result = caseArrayIndexesAccess(arrayIndexesAccess);
			if (result == null)
				result = caseExpression(arrayIndexesAccess);
			if (result == null)
				result = caseElement(arrayIndexesAccess);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ArraysPackage.ARRAY_INITIALIZER: {
			...
			Object result = caseArrayInitializer(arrayInitializer);
			if (result == null)
				result = caseExpression(arrayInitializer);
			if (result == null)
				result = caseElement(arrayInitializer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Array Indexes Access</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Array Indexes Access</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseArrayIndexesAccess(ArrayIndexesAccess object) {
		return null;
	}
