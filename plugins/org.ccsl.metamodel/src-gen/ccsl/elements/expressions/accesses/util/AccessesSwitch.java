...
public class AccessesSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case AccessesPackage.VARIABLE_ACCESS: {
			...
			if (result == null)
				result = caseExpression(variableAccess);
			if (result == null)
		...
		case AccessesPackage.DATA_TYPE_ACCESS: {
			DataTypeAccess dataTypeAccess = (DataTypeAccess) theEObject;
			Object result = caseDataTypeAccess(dataTypeAccess);
			if (result == null)
				result = caseAccess(dataTypeAccess);
			if (result == null)
				result = caseExpression(dataTypeAccess);
			if (result == null)
				result = caseElement(dataTypeAccess);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Type Access</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Type Access</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
