 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.expressions.accesses.impl.VariableAccessImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableAccessImpl extends AccessImpl implements VariableAccess {
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AccessesPackage.VARIABLE_ACCESS__VARIABLE,
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AccessesPackage.VARIABLE_ACCESS__VARIABLE,
					oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AccessesPackage.VARIABLE_ACCESS__VARIABLE:
			if (resolve)
				return getVariable();
