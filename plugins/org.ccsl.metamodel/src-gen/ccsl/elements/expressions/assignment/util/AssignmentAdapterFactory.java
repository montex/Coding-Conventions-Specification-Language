...
public class AssignmentAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AssignmentSwitch modelSwitch = new AssignmentSwitch() {
		...
		public Object caseUnaryAssignment(UnaryAssignment object) {
			return createUnaryAssignmentAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ccsl.elements.expressions.assignment.SimpleAssignment <em>Simple Assignment</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ccsl.elements.expressions.assignment.Assignment <em>Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ccsl.elements.expressions.assignment.UnaryAssignment <em>Unary Assignment</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
