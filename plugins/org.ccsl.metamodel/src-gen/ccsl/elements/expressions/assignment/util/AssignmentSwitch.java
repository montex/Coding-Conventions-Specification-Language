/**
 */
package ccsl.elements.expressions.assignment.util;
...
public class AssignmentSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case AssignmentPackage.SIMPLE_ASSIGNMENT: {
			...
			Object result = caseSimpleAssignment(simpleAssignment);
			if (result == null)
				result = caseExpression(simpleAssignment);
			if (result == null)
				result = caseElement(simpleAssignment);
			if (result == null)
		...
		case AssignmentPackage.ASSIGNMENT: {
			...
			if (result == null)
				result = caseSimpleAssignment(assignment);
			if (result == null)
		...
		case AssignmentPackage.UNARY_ASSIGNMENT: {
			UnaryAssignment unaryAssignment = (UnaryAssignment) theEObject;
			Object result = caseUnaryAssignment(unaryAssignment);
			if (result == null)
				result = caseSimpleAssignment(unaryAssignment);
			if (result == null)
				result = caseExpression(unaryAssignment);
			if (result == null)
				result = caseElement(unaryAssignment);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public Object caseSimpleAssignment(SimpleAssignment object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Unary Assignment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Unary Assignment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseUnaryAssignment(UnaryAssignment object) {
		return null;
	}
