 ...
 * @generated
 */
public class InvocationsSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case InvocationsPackage.METHOD_INVOCATION: {
			...
			if (result == null)
				result = caseInvocation(methodInvocation);
			if (result == null)
				result = caseExpression(methodInvocation);
			if (result == null)
		...
		case InvocationsPackage.CONSTRUCTOR_INVOCATION: {
			...
			Object result = caseConstructorInvocation(constructorInvocation);
			if (result == null)
				result = caseInvocation(constructorInvocation);
			if (result == null)
				result = caseExpression(constructorInvocation);
			if (result == null)
				result = caseElement(constructorInvocation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case InvocationsPackage.SUPER_METHOD_INVOCATION: {
			...
			if (result == null)
				result = caseInvocation(superMethodInvocation);
			if (result == null)
				result = caseExpression(superMethodInvocation);
			if (result == null)
