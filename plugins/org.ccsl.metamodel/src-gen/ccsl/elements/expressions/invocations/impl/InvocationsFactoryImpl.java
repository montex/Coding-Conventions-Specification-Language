 ...
 * @generated
 */
public class InvocationsFactoryImpl extends EFactoryImpl implements InvocationsFactory {
	/**
	 ...
	 * @generated
	 */
	public static InvocationsFactory init() {
		try {
			InvocationsFactory theInvocationsFactory = (InvocationsFactory) EPackage.Registry.INSTANCE
					.getEFactory(InvocationsPackage.eNS_URI);
			if (theInvocationsFactory != null) {
				return theInvocationsFactory;
			}
		} catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new InvocationsFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public InvocationsPackage getInvocationsPackage() {
		return (InvocationsPackage) getEPackage();
	}
	 ...
	 * @generated
	 */
	public static InvocationsPackage getPackage() {
		return InvocationsPackage.eINSTANCE;
	}

} //InvocationsFactoryImpl
