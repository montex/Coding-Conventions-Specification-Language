...
import ccsl.elements.expressions.invocations.SuperMethodInvocation;
 ...
 * @generated
 */
public class InvocationsPackageImpl extends EPackageImpl implements InvocationsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ccsl.elements.expressions.invocations.InvocationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private InvocationsPackageImpl() {
		super(eNS_URI, InvocationsFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link InvocationsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static InvocationsPackage init() {
		if (isInited)
			return (InvocationsPackage) EPackage.Registry.INSTANCE.getEPackage(InvocationsPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredInvocationsPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		InvocationsPackageImpl theInvocationsPackage = registeredInvocationsPackage instanceof InvocationsPackageImpl
				? (InvocationsPackageImpl) registeredInvocationsPackage
				: new InvocationsPackageImpl();
		...
		theInvocationsPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(InvocationsPackage.eNS_URI, theInvocationsPackage);
		return theInvocationsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getInvocation_ArgsKind() {
	 ...
	 * @generated
	 */
	public EReference getInvocation_Method() {
	 ...
	 * @generated
	 */
	public EReference getInvocation_TypeArgs() {
	 ...
	 * @generated
	 */
	public EAttribute getInvocation_TypeArgsKind() {
		return (EAttribute) invocationEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getConstructorInvocation_Constructor() {
	 ...
	 * @generated
	 */
	public InvocationsFactory getInvocationsFactory() {
		return (InvocationsFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(invocationEClass, INVOCATION__ARGS_KIND);
		createEReference(invocationEClass, INVOCATION__METHOD);
		createEReference(invocationEClass, INVOCATION__ARGS);
		createEReference(invocationEClass, INVOCATION__TYPE_ARGS);
		createEAttribute(invocationEClass, INVOCATION__TYPE_ARGS_KIND);

		constructorInvocationEClass = createEClass(CONSTRUCTOR_INVOCATION);
		createEReference(constructorInvocationEClass, CONSTRUCTOR_INVOCATION__CONSTRUCTOR);
	...
	public void initializePackageContents() {
		...
		invocationEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
		constructorInvocationEClass.getESuperTypes().add(this.getInvocation());
		...
		initEReference(getMethodInvocation_From(), theExpressionsPackage.getExpression(), null, "from", null, 0, 1,
		...
		initEClass(invocationEClass, Invocation.class, "Invocation", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInvocation_ArgsKind(), theccslPackage.getCollectionKind(), "argsKind", "ANY", 0, 1,
				Invocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getInvocation_Method(), theMethodPackage.getSimpleMethod(), null, "method", null, 0, 1,
				Invocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInvocation_Args(), theExpressionsPackage.getExpression(), null, "args", null, 0, -1,
				Invocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInvocation_TypeArgs(), theDatatypePackage.getObjectType(), null, "typeArgs", null, 0, -1,
				Invocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInvocation_TypeArgsKind(), theccslPackage.getCollectionKind(), "typeArgsKind", "ANY", 0, 1,
				Invocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(constructorInvocationEClass, ConstructorInvocation.class, "ConstructorInvocation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConstructorInvocation_Constructor(), theMethodPackage.getConstructor(), null, "constructor",
				null, 0, 1, ConstructorInvocation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
