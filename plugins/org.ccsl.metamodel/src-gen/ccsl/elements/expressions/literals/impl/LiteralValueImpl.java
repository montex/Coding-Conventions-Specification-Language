 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.expressions.literals.impl.LiteralValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralValueImpl extends ExpressionImpl implements LiteralValue {
	...
	protected EClass eStaticClass() {
		return LiteralsPackage.Literals.LITERAL_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LiteralsPackage.LITERAL_VALUE__VALUE, oldValue,
					value));
	}
