 ...
 * @generated
 */
public class TryCatchPackageImpl extends EPackageImpl implements TryCatchPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ccsl.elements.statements.tryCatch.TryCatchPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TryCatchPackageImpl() {
		super(eNS_URI, TryCatchFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link TryCatchPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TryCatchPackage init() {
		if (isInited)
			return (TryCatchPackage) EPackage.Registry.INSTANCE.getEPackage(TryCatchPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTryCatchPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		TryCatchPackageImpl theTryCatchPackage = registeredTryCatchPackage instanceof TryCatchPackageImpl
				? (TryCatchPackageImpl) registeredTryCatchPackage
				: new TryCatchPackageImpl();
		...
		theTryCatchPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TryCatchPackage.eNS_URI, theTryCatchPackage);
		return theTryCatchPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTryStatement_CatchClausesKind() {
		return (EAttribute) tryStatementEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTryStatement_ResourcesKind() {
		return (EAttribute) tryStatementEClass.getEStructuralFeatures().get(4);
	}
	...
	public EReference getTryStatement_TryBlock() {
		return (EReference) tryStatementEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getCatchClause_Variable() {
	 ...
	 * @generated
	 */
	public EReference getCatchClause_HandledExceptions() {
	 ...
	 * @generated
	 */
	public TryCatchFactory getTryCatchFactory() {
		return (TryCatchFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(tryStatementEClass, TRY_STATEMENT__CATCH_CLAUSES_KIND);
		createEReference(tryStatementEClass, TRY_STATEMENT__RESOURCES);
		createEAttribute(tryStatementEClass, TRY_STATEMENT__RESOURCES_KIND);
		...
		createEReference(catchClauseEClass, CATCH_CLAUSE__VARIABLE);
		createEReference(catchClauseEClass, CATCH_CLAUSE__HANDLED_EXCEPTIONS);
	}
	...
	public void initializePackageContents() {
		...
		tryStatementEClass.getESuperTypes().add(theStatementsPackage.getStatement());
		catchClauseEClass.getESuperTypes().add(theStatementsPackage.getStatement());

		// Initialize classes and features; add operations and parameters
		initEClass(tryStatementEClass, TryStatement.class, "TryStatement", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTryStatement_CatchClauses(), this.getCatchClause(), null, "catchClauses", null, 0, -1,
				TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTryStatement_FinallyBlock(), theStatementsPackage.getBlock(), null, "finallyBlock", null, 0,
				1, TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTryStatement_CatchClausesKind(), theccslPackage.getCollectionKind(), "catchClausesKind",
				"ANY", 0, 1, TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTryStatement_Resources(), theExpressionsPackage.getExpression(), null, "resources", null, 0,
				-1, TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTryStatement_ResourcesKind(), theccslPackage.getCollectionKind(), "resourcesKind", "ANY", 0,
				1, TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTryStatement_TryBlock(), theStatementsPackage.getBlock(), null, "tryBlock", null, 0, 1,
				TryStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(catchClauseEClass, CatchClause.class, "CatchClause", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCatchClause_Body(), theStatementsPackage.getBlock(), null, "body", null, 0, 1,
				CatchClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCatchClause_Variable(), theVariablePackage.getParameterVariable(), null, "variable", null, 0,
				1, CatchClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCatchClause_HandledExceptions(), theComplexTypePackage.getJClass(), null, "handledExceptions",
				null, 0, -1, CatchClause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
