/**
 */
package ccsl.elements.statements.tryCatch.util;
 ...
 * @generated
 */
public class TryCatchAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static TryCatchPackage modelPackage;
	 ...
	 * @generated
	 */
	public TryCatchAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = TryCatchPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected TryCatchSwitch modelSwitch = new TryCatchSwitch() {
		public Object caseTryStatement(TryStatement object) {
			return createTryStatementAdapter();
		}

		public Object caseCatchClause(CatchClause object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link ccsl.elements.statements.tryCatch.TryStatement <em>Try Statement</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ccsl.elements.statements.tryCatch.CatchClause <em>Catch Clause</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
