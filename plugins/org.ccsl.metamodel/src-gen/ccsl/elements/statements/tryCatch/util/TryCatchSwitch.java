...
public class TryCatchSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case TryCatchPackage.TRY_STATEMENT: {
			...
			Object result = caseTryStatement(tryStatement);
			if (result == null)
				result = caseStatement(tryStatement);
			if (result == null)
				result = caseElement(tryStatement);
			if (result == null)
		...
		case TryCatchPackage.CATCH_CLAUSE: {
			...
			Object result = caseCatchClause(catchClause);
			if (result == null)
