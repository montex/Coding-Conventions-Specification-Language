 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.statements.impl.AssertStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link ccsl.elements.statements.impl.AssertStatementImpl#getMessage <em>Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssertStatementImpl extends StatementImpl implements AssertStatement {
	...
	protected EClass eStaticClass() {
		return StatementsPackage.Literals.ASSERT_STATEMENT;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatementsPackage.ASSERT_STATEMENT__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StatementsPackage.ASSERT_STATEMENT__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.ASSERT_STATEMENT__EXPRESSION,
	...
	public NotificationChain basicSetMessage(Expression newMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatementsPackage.ASSERT_STATEMENT__MESSAGE, oldMessage, newMessage);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMessage != message) {
			...
			if (message != null)
				msgs = ((InternalEObject) message).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StatementsPackage.ASSERT_STATEMENT__MESSAGE, null, msgs);
			if (newMessage != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.ASSERT_STATEMENT__MESSAGE,
