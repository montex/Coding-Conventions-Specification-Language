 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.statements.impl.ReturnStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatementsPackage.RETURN_STATEMENT__EXPRESSION, oldExpression, newExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject) expression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StatementsPackage.RETURN_STATEMENT__EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatementsPackage.RETURN_STATEMENT__EXPRESSION,
