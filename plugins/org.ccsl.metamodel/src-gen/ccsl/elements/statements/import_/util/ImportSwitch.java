/**
 */
package ccsl.elements.statements.import_.util;
...
public class ImportSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case ImportPackage.IMPORTABLE_ELEMENT: {
			ImportableElement importableElement = (ImportableElement) theEObject;
			Object result = caseImportableElement(importableElement);
			if (result == null)
				result = caseElement(importableElement);
			if (result == null)
		...
		case ImportPackage.IMPORT_STATEMENT: {
			...
			Object result = caseImportStatement(importStatement);
			if (result == null)
				result = caseStatement(importStatement);
			if (result == null)
				result = caseElement(importStatement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public Object caseImportStatement(ImportStatement object) {
		return null;
	}
