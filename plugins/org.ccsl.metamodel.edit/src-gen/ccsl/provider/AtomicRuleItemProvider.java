...
public class AtomicRuleItemProvider extends RuleItemProvider {
	...
	protected void addSubjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AtomicRule_subject_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_AtomicRule_subject_feature",
								"_UI_AtomicRule_type"),
						ccslPackage.Literals.ATOMIC_RULE__SUBJECT, true, false, true, null, null, null));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ccslPackage.Literals.ATOMIC_RULE__CONTEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ccslPackage.Literals.ATOMIC_RULE__CONTEXT,
