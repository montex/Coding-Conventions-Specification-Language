...
/**
 * This is the item provider adapter for a {@link ccsl.elements.namedElements.method.SimpleMethod} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleMethodItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SimpleMethodItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ElementsPackage.Literals.ANNOTABLE__ANNOTATIONS);
	...
	/**
	 * This returns SimpleMethod.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimpleMethod"));
	}
	...
	public String getText(Object object) {
		String label = ((SimpleMethod) object).getUniqueName();
		return label == null || label.length() == 0 ? getString("_UI_SimpleMethod_type")
				: getString("_UI_SimpleMethod_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimpleMethod.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ElementsPackage.Literals.ANNOTABLE__ANNOTATIONS,
