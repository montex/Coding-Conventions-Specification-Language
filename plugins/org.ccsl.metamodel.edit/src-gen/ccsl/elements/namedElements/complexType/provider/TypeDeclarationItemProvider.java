...
/**
 * This is the item provider adapter for a {@link ccsl.elements.namedElements.complexType.TypeDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeDeclarationItemProvider extends NamedElementItemProvider {
	...
	protected void addStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TypeDeclaration_static_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TypeDeclaration_static_feature",
								"_UI_TypeDeclaration_type"),
						ComplexTypePackage.Literals.TYPE_DECLARATION__STATIC, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addInheritancePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TypeDeclaration_inheritance_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TypeDeclaration_inheritance_feature",
								"_UI_TypeDeclaration_type"),
						ComplexTypePackage.Literals.TYPE_DECLARATION__INHERITANCE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComplexTypePackage.Literals.TYPE_DECLARATION__IMPORTS);
			childrenFeatures.add(ComplexTypePackage.Literals.TYPE_DECLARATION__NESTED_TYPES);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TypeDeclaration_type")
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ComplexTypePackage.Literals.TYPE_DECLARATION__IMPORTS,
				ImportFactory.eINSTANCE.createImportStatement()));

		newChildDescriptors.add(createChildParameter(ComplexTypePackage.Literals.TYPE_DECLARATION__NESTED_TYPES,
