...
/**
 * This is the item provider adapter for a {@link ccsl.elements.namedElements.complexType.ComplexTypeDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexTypeDeclarationItemProvider extends TypeDeclarationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ComplexTypeDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addSuperInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ComplexTypeDeclaration_superInterfaces_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ComplexTypeDeclaration_superInterfaces_feature",
						"_UI_ComplexTypeDeclaration_type"),
				ComplexTypePackage.Literals.COMPLEX_TYPE_DECLARATION__SUPER_INTERFACES, true, false, true, null, null,
				null));
	}
	...
	/**
	 * This returns ComplexTypeDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComplexTypeDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((ComplexTypeDeclaration) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ComplexTypeDeclaration_type")
				: getString("_UI_ComplexTypeDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ComplexTypeDeclaration.class)) {
