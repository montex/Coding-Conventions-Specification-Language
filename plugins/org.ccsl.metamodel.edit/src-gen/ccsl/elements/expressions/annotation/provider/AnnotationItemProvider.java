...
/**
 * This is the item provider adapter for a {@link ccsl.elements.expressions.annotation.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider extends ExpressionItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Annotation_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Annotation_type_feature",
								"_UI_Annotation_type"),
						AnnotationPackage.Literals.ANNOTATION__TYPE, true, false, true, null, null, null));
	}
	...
	protected void addValuesKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Annotation_valuesKind_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Annotation_valuesKind_feature",
								"_UI_Annotation_type"),
						AnnotationPackage.Literals.ANNOTATION__VALUES_KIND, true, false, false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnnotationPackage.Literals.ANNOTATION__VALUES);
		}
	...
	public String getText(Object object) {
		String label = ((Annotation) object).getUniqueName();
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AnnotationPackage.Literals.ANNOTATION__VALUES,
