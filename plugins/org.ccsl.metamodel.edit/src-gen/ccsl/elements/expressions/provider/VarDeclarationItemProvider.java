...
/**
 * This is the item provider adapter for a {@link ccsl.elements.expressions.VarDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarDeclarationItemProvider extends ExpressionItemProvider {
	/**
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.VAR_DECLARATION__VARIABLE);
		}
	...
	public String getText(Object object) {
		String label = ((VarDeclaration) object).getUniqueName();
		return label == null || label.length() == 0 ? getString("_UI_VarDeclaration_type")
				: getString("_UI_VarDeclaration_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ExpressionsPackage.Literals.VAR_DECLARATION__VARIABLE,
