...
/**
 * This is the item provider adapter for a {@link ccsl.elements.expressions.arrays.ArrayCreation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayCreationItemProvider extends ExpressionItemProvider {
	/**
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDimensionsKindPropertyDescriptor(object);
		}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ArrayCreation_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ArrayCreation_type_feature",
								"_UI_ArrayCreation_type"),
						ArraysPackage.Literals.ARRAY_CREATION__TYPE, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Dimensions Kind feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDimensionsKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ArrayCreation_dimensionsKind_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ArrayCreation_dimensionsKind_feature",
								"_UI_ArrayCreation_type"),
						ArraysPackage.Literals.ARRAY_CREATION__DIMENSIONS_KIND, true, false, false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArraysPackage.Literals.ARRAY_CREATION__INITIALIZER);
			childrenFeatures.add(ArraysPackage.Literals.ARRAY_CREATION__DIMENSIONS);
		}
	...
	public String getText(Object object) {
		String label = ((ArrayCreation) object).getUniqueName();
		return label == null || label.length() == 0 ? getString("_UI_ArrayCreation_type")
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ArraysPackage.Literals.ARRAY_CREATION__INITIALIZER,
				ArraysFactory.eINSTANCE.createArrayInitializer()));

		newChildDescriptors.add(createChildParameter(ArraysPackage.Literals.ARRAY_CREATION__DIMENSIONS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify = childFeature == ArraysPackage.Literals.ARRAY_CREATION__INITIALIZER
				|| childFeature == ArraysPackage.Literals.ARRAY_CREATION__DIMENSIONS;
