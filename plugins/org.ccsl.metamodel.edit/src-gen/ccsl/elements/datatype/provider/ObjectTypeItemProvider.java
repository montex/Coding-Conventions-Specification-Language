...
/**
 * This is the item provider adapter for a {@link ccsl.elements.datatype.ObjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectTypeItemProvider extends DataTypeItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ObjectType) object).getUniqueName();
		return label == null || label.length() == 0 ? getString("_UI_ObjectType_type")
