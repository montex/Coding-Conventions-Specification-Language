...
/**
 * This is the item provider adapter for a {@link ccsl.elements.statements.ThrowStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThrowStatementItemProvider extends StatementItemProvider {
	/**
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementsPackage.Literals.THROW_STATEMENT__EXPRESSION);
		}
	...
	public String getText(Object object) {
		String label = ((ThrowStatement) object).getUniqueName();
		return label == null || label.length() == 0 ? getString("_UI_ThrowStatement_type")
				: getString("_UI_ThrowStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case StatementsPackage.THROW_STATEMENT__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(StatementsPackage.Literals.THROW_STATEMENT__EXPRESSION,
